...
//	DSI_CMD_SET_SRGB_OFF,
	...
	DSI_CMD_SET_CABC_MODE_COMMAND1,
	DSI_CMD_SET_CABC_MODE_COMMAND2,

	DSI_CMD_SET_MAX
};

enum dsi_cmd_set_cabc_mode {
	DSI_CMD_SET_CABC_MODE0 = 0,
	DSI_CMD_SET_CABC_MODE1,
	DSI_CMD_SET_CABC_MODE2
};
